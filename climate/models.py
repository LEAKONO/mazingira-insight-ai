...
class Region(models.Model):
    ...
    # GeoDjango PointField for spatial queries
    location = gis_models.PointField(help_text="Geographic coordinates (latitude, longitude)")
    
    # Alternative: JSONField if GeoDjango is not available
    geojson = models.JSONField(blank=True, null=True, help_text="GeoJSON representation")
